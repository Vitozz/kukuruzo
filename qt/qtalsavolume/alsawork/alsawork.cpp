...
void AlsaWork::setAlsaVolume(int volume) { currentAlsaDevice_->setDeviceVolume(static_cast<double>(volume)); }
...
const QStringList &AlsaWork::getVolumeMixers() const { return currentAlsaDevice_->mixers(); }
