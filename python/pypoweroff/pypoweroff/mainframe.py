...
class mainFrame():
    def __init__(self):
        ...
        #SpinButtons
        self.timespin = self.widgetTree.get_widget('timespin')
        self.hour_spin = self.widgetTree.get_widget('hour_spin')
        self.min_spin = self.widgetTree.get_widget('min_spin')
        #MainWindowLabels
        self.window_label1 = self.widgetTree.get_widget('label1')
        self.window_label2 = self.widgetTree.get_widget('label3')
        #ToggleButtons
...
#
    def initLanguage(self):
        ...
        button = self.widgetTree.get_widget('poffButton')
...
#
    ...
    def SaveSettings(self):
        timeout = int(self.timespin.get_value())
        htime = int(self.hour_spin.get_value())
        mtime = int(self.min_spin.get_value())
...
#
    ...
    def GetTimeToPoff(self):
        if self.hour_spin.get_value()>0:
            self.hour = self.hour_spin.get_value()
        else:
            self.hour = 0
        if self.min_spin.get_value()>0:
            self.minutes = self.min_spin.get_value()
        else:
            self.minutes = 0
