...
int PulseDevice::card() const { return card_; }

device_type PulseDevice::type() const { return type_; }

const QString &PulseDevice::name() const { return name_; }

const QString &PulseDevice::description() const { return description_; }
