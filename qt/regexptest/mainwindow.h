...
private:
    ...
    QList <QStringList> CheckExpression(const QString &regexp, const QString &text);
    QString GetRegexpList(const QList <QStringList> &matches, const int &parm, const int &pos);
    void readSettings();
    void writeSettings();
    QString replaceNotGreedy(QString text);
