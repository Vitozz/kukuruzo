...
!define PRODUCT_NAME "pyInterpol"
...
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\hostname.exe"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "pyInterpol"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\pyinterpol.exe"
...
OutFile "setup.exe"
InstallDir "$PROGRAMFILES\pyInterpol"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\pyInterpol.lnk" "$INSTDIR\pyinterpol.exe"
  CreateShortCut "$DESKTOP\pyInterpol.lnk" "$INSTDIR\pyinterpol.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\lib\gettext\hostname.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\lib\gettext\hostname.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\pyInterpol.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\pyInterpol.lnk"
